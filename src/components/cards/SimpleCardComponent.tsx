...
const SimpleCardComponent = () => {
  ...
  <img className="w-full h-48 object-cover rounded-t-lg" src="https://via.placeholder.com/150" alt="Sample Image" />
  <div className="mt-4 p-6">
    <h2 className="text-lg font-bold text-gray-900">Card Title</h2>
    <p className="text-white mt-2">This is a description for the card. It's brief but informative.</p>
