  ...
  return (
    <div className="flex border rounded-lg items-center text-sm px-1">
      <Input
        ...
        className="p-0 outline-none w-6 border-none text-center dark:text-white"
        placeholder="M"
      />
      ...
      <Input
        ...
        className="p-0 outline-none w-7 border-none text-center dark:text-white"
        placeholder="D"
      />
      <span className="opacity-20 -mx-px">/</span>
      <Input
        ...
        className="p-0 outline-none w-12 border-none text-center dark:text-white"
        placeholder="YYYY"
      />
    </div>
  )
